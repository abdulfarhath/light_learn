    ...
    return (
        <div className="flex-1 p-6 overflow-y-auto flex flex-col gap-6 max-w-7xl mx-auto w-full no-scrollbar">
            ...
            <Card className="w-full">
                <h3 className="text-xl font-semibold text-text-main mb-1">✅ Teacher Tasks</h3>
                <p className="text-text-muted text-sm mb-4">Track your lesson planning and grading</p>
